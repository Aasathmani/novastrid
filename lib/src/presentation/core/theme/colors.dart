...
class AppColors {
  ...
  static const Color primary = Color(0xFF25247B);
  static const Color onPrimary = Color(0xFFFFFFFF);
  static const Color secondary = Color(0xFF14C0F3);
  static const Color primaryDark = Color(0xff2B3164);
  static const Color tertiary = Color(0xFFFFCB08);
  static const Color primaryLight = Color(0xff2B3164);
  static const Color accent = Color(0xff2B3164);
  static const Color surface = Color(0xFF6D6E70);
  ...
  static const Color cyanBlue = Color(0xFF14C0F3);
  static const Color deepIndigo = Color(0xFF25247B);
  static const Color yellowLight = Color(0xFFFFCB08);
